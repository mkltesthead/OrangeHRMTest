...
namespace OrangeHRMTest.Pages
{
    public class AllPage
    {
        ...
        // It mimics a tree structure where the branches (nodes with child nodes) are dictionaries and the leaves (nodes without child nodes) are arrays
        // It might be nice to implement it recursively - where each node would have an id, a parent node id. Leaves would have non-null arrays
        //
